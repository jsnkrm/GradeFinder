...
public class sslcActivity extends AppCompatActivity {
    ...
    public ArrayList<gradeDef> sslcGradeSystem = new ArrayList<>();

    public ArrayList<idArray> sslcId = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll.setBackgroundResource(R.color.sslc);
            ...
            public void onClick(View v) {
                ...
                if (!validateAddGrade()){}
                    ...
                    for (int i = 0; i < n; i++) {
                        ...
                        sslcGradeSystem.add(new gradeDef(lower, upper, s));
